...
?>
 ...
 if (isset($_POST['btnLogin'])){
  ...
  if(isset($_POST['remember'])){
    setcookie('admin_id',$row['id'],time()+3*24*60*60);
    setcookie('admin_username',$row['username'],time()+3*24*60*60);
    setcookie('admin_name',$row['name'],time()+3*24*60*60);
    setcookie('admin_email',$row['email'],time()+3*24*60*60);
  }
...
<div class="container">
  <h3 style="font-weight: bold; text-align: center;">Owner Login</h3><hr><br>
  <?php if(isset($msg)){ ?>
